...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <h4 class="py-2">Add new project</h4>
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" value="{{ old('name') }}" placeholder="Nama Project" autocomplete="off" required>
                                    @error('name')
                                        <span class="text-danger">
                                            {{ $message }}
                                        </span>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea id="description" class="form-control" name="description" placeholder="Deskripsi Project" autocomplete="off" required>{{ old('description') }}</textarea>
                                    @error('description')
                                        <span class="text-danger">
                                            {{ $message }}
                                        </span>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="url" id="url_project" name="url_project" value="{{ old('url_project') }}" class="form-control" placeholder="URL Project" autocomplete="off" required>
                                    @error('url_project')
                                        <span class="text-danger">
                                            {{ $message }}
                                        </span>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select id="category_project_id" name="category_project_id" class="form-select" required>
                                        ...
                                        @forelse ($category_projects as $id => $category_project_name)
                                            <option value="{{ $id }}" @selected(old('category_project_id') == $id)>{{ $category_project_name ?? '' }}</option>
                                        @empty
                                            {{-- not found --}}
                                        @endforelse
                                ...
                                <div class="mb-3">
                                    ...
                                    <select id="is_visible" name="is_visible" class="form-select" required>
                                        ...
                                        <option value="1" @selected(old('is_visible') == "1")>Visible</option>
