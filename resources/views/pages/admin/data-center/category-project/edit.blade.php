    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Edit category project</li>
            </ol>
        </nav>

        <div class="card p-5">
            <h4>Edit category project</h4>
            ...
            <form action="{{ route('category_project.update', $category_project->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="form-group mt-3">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="name" placeholder="Category name"
                            name="name" value="{{ old('name', $category_project->name ?? '') }}" autocomplete="off" required>
                            @error('name')
